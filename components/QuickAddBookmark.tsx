...
export function QuickAddBookmark() {
  ...
  // Predefined tags
  const availableTags = [
    'Work', 'Personal', 'Tutorial', 'News', 'Entertainment',
    'Shopping', 'Social Media', 'Documentation', 'Tools', 'Design',
    'Programming', 'Research', 'Education', 'Finance', 'Health'
  ];
						...
						<motion.div
							...
							<div className="flex items-center gap-3 mb-4">
                                ...
                                <button
                                    type="button"
                                    onClick={() => setIsOpen(false)}
                                    className="ml-auto p-2 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 rounded-lg hover:from-red-600 hover:via-pink-600 hover:to-yellow-400 transition-all shadow-lg hover:scale-105 focus:outline-none focus:ring-2 focus:ring-pink-400"
                                    aria-label="Close"
                                >
