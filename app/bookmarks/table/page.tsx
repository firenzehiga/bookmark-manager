      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="glass-dark rounded-2xl p-4 md:p-6 mb-6 border border-gray-700/50">
          ...
          <div className="mt-4 text-sm text-gray-400">
            Menampilkan {filteredBookmarks.length} dari {bookmarks.length} bookmark
          </div>
        </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-800/50 border-b border-gray-700">
                  <tr>
                    <th className="text-left p-4 text-gray-300 font-semibold">Judul</th>
                    <th className="text-left p-4 text-gray-300 font-semibold hidden md:table-cell">URL</th>
                    <th className="text-left p-4 text-gray-300 font-semibold hidden lg:table-cell">Kategori</th>
                    <th className="text-left p-4 text-gray-300 font-semibold hidden xl:table-cell">Tanggal</th>
                    <th className="text-center p-4 text-gray-300 font-semibold">Aksi</th>
                  </tr>
                </thead>
                <tbody>
                    ...
                    >
                      ...
                      <td className="p-4 hidden md:table-cell">
                        <div className="flex items-center gap-2">
                          ...
                          >
                            <span className="truncate">{truncateUrl(bookmark.url, 35)}</span>
          ...
          <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
            <div className="bg-gray-900 rounded-2xl border border-gray-700 w-full max-w-4xl max-h-[90vh] overflow-hidden">
              <div className="flex items-center justify-between p-4 border-b border-gray-700">
                <h3 className="text-lg font-semibold text-white">Preview Website</h3>
                <button
